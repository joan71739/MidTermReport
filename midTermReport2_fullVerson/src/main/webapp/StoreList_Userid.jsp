...
<div class="container">		
		...
		%>
			<h3>店家帳號：<%=lostuserid%></h3>
			
			
		<form>
			<fieldset>
				<lable id="lb">店家ID：${reg_store.stuserid} </label> <br>
				<lable id="lb">店家加入時間：${reg_store.startdate}</label> <br>
				<lable id="lb">店家帳號：<%=lostuserid%></label> <br>
				<lable id="lb">店家名稱：${reg_store.title}</label> <br>
				<lable id="lb">店長：${reg_store.manager}</label> <br>
				<lable id="lb">店家地址：${reg_store.stadd}</label> <br>
				<lable id="lb">聯絡電話：${reg_store.tel}</label> <br>
				<lable id="lb">店家介紹：${reg_store.intro}</label> <br>
		</fieldset>
	</form>
